...
namespace lab_8
{
    public partial class Lab4Form : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Help.ShowHelp(this, "HELP2.chm", "obshchaya_skhema.htm");
        }

        private void HELP(object sender, HelpEventArgs hlpevent)
        {
            //HelpNavigator topic = HelpNavigator.Topic;
            Help.ShowHelp(this, "HELP2.chm", "obshchaya_skhema.htm");
        }
    }
}
